...
BLOG_AUTHOR = "lampze"  # (translatable)
BLOG_TITLE = "lampze's blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://lampze.github.io/blog/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "1229408499@qq.com"
BLOG_DESCRIPTION = "This is a blog for me"  # (translatable)
...
# before </head>
# (translatable)
EXTRA_HEAD_DATA = "<style>body { font-size: 1.6em; }</style>"
